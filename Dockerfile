...
WORKDIR /go/src/github.com/alecmerdler/spicedb-benthos-plugin
...
COPY --from=build /go/src/github.com/alecmerdler/spicedb-benthos-plugin/main benthos
...
LABEL org.opencontainers.image.source https://github.com/alecmerdler/spicedb-benthos-plugin
